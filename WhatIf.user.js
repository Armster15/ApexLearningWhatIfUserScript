...
(function () {
    // @ts-ignore
    const isDev = typeof esbuildIsDev === 'undefined' ? false : esbuildIsDev;
    const main = async () => {
        var _a, _b, _c, _d;
        // DEV: Reset all the stuff
        document
            .querySelectorAll(".what-if-btn, .what-if-edit-grade-container, .ionicon, .what-if-overall-score-text, .what-if-overall-percent-complete-text")
...
`);
  ...
  `;
        ...
        (_d = (_c = document
            .querySelector("div.activitiesListSection")) === null || _c === void 0 ? void 0 : _c.parentElement) === null || _d === void 0 ? void 0 : _d.insertBefore(overallPercentCompleteText, document.querySelector("div.activitiesListSection"));
        ...
        const percentOfCourseCompleted = () => {
            var completed = 0;
            for (const row of rows) {
                let text = row.children[4].innerText.toLowerCase();
    ...
    if (isDev)
        ...
        waitForKeyElements(`div.ag-root-wrapper`, () => main());
})();